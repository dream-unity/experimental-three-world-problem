...
const RELEASE = '20260830-sovereign-nocturne-16';
const RENDERER_PATH = 'visual-parts/sovereign-nocturne-16.js';
...
assert.match(loader, /visual-parts\/sovereign-nocturne-16\.js/);
