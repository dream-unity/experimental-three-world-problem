...
assert.match(index, /styles\.css\?v=20260830-sovereign-resonator-2/);
assert.match(index, /unity-cycle\.css\?v=20260830-sovereign-resonator-2/);
assert.match(index, /light-theme\.js\?v=20260830-sovereign-resonator-2/);
assert.match(index, /unity-ui\.js\?v=20260830-sovereign-resonator-2/);
assert.match(index, /main\.js\?v=20260830-sovereign-resonator-2/);
...
assert.match(loader, /VERSION = '20260830-sovereign-resonator-2'/);
