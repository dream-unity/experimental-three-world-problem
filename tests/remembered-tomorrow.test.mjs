...
const RELEASE = '20260830-sovereign-nocturne-15';
const RENDERER_PATH = 'visual-parts/sovereign-nocturne-15.js';
...
assert.match(loader, /visual-parts\/sovereign-nocturne-15\.js/);
