...
The overview can be orbited by mouse or touch. One dense, self-crossing 3D body—the **Sovereign Resonator**—moves through **Dream → Compress → Realise → Return**. Electric-cyan possibility, emerald agency and ultraviolet matter are three structural sheaths of the same living chord. They enter one severe compression throat, acquire nine load-bearing tension elements and return as memory-bearing filaments. Dream worlds are therefore compressed, synthesised and realised in the physical before returning changed to the ether that can dream again.

The colourless offset double is the inherited predictive ghost. It first appears to anticipate the vivid body; disciplined interaction demotes it into a trailing scaffold. The mirror is not destroyed, worshipped or escaped—it becomes an instrument. Long-breath expansion, harmonic convergence, held subtraction, prismatic reconstitution, crown and release alter the body's actual material grammar instead of producing an equaliser or decorative waveform. In the deepest subtraction the field concentrates into a compact gravity seed while the full-scale ghost remains; reconstitution unfolds the seed into a more coherent body. Ultraviolet facets and controlled amber serrations make **grace with teeth** load-bearing rather than rhetorical. Dream Machine is a polyhedral cognition field; Dream Maker is a converging tension braid; Dream World is an accreted material lattice. Selecting a world exposes its internal triad; selecting an internal force opens the corresponding game.

The homepage retains **I Remember Tomorrow** as its published score and exposes a persistent score control. Its measured low, mid and high energy, spectral change and attacks affect the gravity seed, sheath width, throat pressure, tension convergence, crown and release. A deterministic full-song anatomy preserves the material narrative before browser audio policy allows live analysis. Browsers that defer audible autoplay start it on the visitor's first interaction. An explicit off choice is remembered locally.

The visual language continues into all nine games and the Social Agency Lab: the former neon bunker is translated onto the same white ground, hard-edged panels and cyan–emerald–ultraviolet material spectrum. The interaction system remains intact, but it now reads as another state of the Sovereign Resonator rather than a separate product skin.
...
- `visual-parts/sovereign-resonator-11.txt` — procedural Sovereign Resonator, temporal echo, compression throat, harmonic tension ribs, gravity seed, prismatic reconstitution and three immersive world fields.
